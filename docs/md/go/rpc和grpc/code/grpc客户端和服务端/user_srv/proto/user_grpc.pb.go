...
func (c *userServiceClient) GetUserByMobile(ctx context.Context, in *MobileRequest, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, "/user.UserService/GetUserByMobile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserById(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *CreateUserInfo, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (c *userServiceClient) UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
type UserServiceServer interface {
	...
	// 通过id查询用户
	GetUserById(context.Context, *UserIdRequest) (*UserInfo, error)
	// 创建用户
	CreateUser(context.Context, *CreateUserInfo) (*UserInfo, error)
	// 更新用户
	UpdateUser(context.Context, *UpdateUserInfo) (*UserInfo, error)
	// 检查用户密码
...
func (UnimplementedUserServiceServer) GetUserByMobile(context.Context, *MobileRequest) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByMobile not implemented")
}
func (UnimplementedUserServiceServer) GetUserById(context.Context, *UserIdRequest) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserById not implemented")
}
func (UnimplementedUserServiceServer) CreateUser(context.Context, *CreateUserInfo) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserServiceServer) UpdateUser(context.Context, *UpdateUserInfo) (*UserInfo, error) {
...
func _UserService_GetUserByMobile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserService/GetUserByMobile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
